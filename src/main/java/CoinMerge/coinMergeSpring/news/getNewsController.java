...
public class getNewsController {
    ...
    public String getNews() throws IOException, InterruptedException, ParseException, JSONException {
        String coinName = "비트코인";
        ArrayList<newsDTO> searchResult = callNewsGetter(coinName);//news를 배열형식으로 받아옴
    ...
    public String newsApi(String search) throws IOException, InterruptedException, ParseException, JSONException {
        //uri를 만들기 위한 함수
        String text = null;
        try {
    ...
    public ArrayList<newsDTO> callNewsGetter(String search) throws JSONException, IOException, ParseException, InterruptedException {
        //api를 호출해서 뉴스를 받아온다.
